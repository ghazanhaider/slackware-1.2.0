...
#
# This one comes from disk: IV1 (Interviews apps)
...
# 
#
doc: DOC word processor
doc: REC
idraw: IDRAW graphics editor
idraw: REC
iv_docs: IV documentation
iv_docs: OPT
iv_misc: DOC style sheets and misc files.
iv_misc: REC
iv_bin: Other IV binaries
iv_bin: OPT
iv_man: Man pages for IV programming
iv_man: OPT
iv_libs: Static libs and include files.
iv_libs: OPT
ivdevbin: Development utilities for IV.
ivdevbin: OPT
